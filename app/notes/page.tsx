...
export default async function Notes() {
    ...
    return <div>
        <h1>
            <div className="grid grid-cols-3 pt-6 ml-2">
                {notes?.map((note) => {
...
function Note({note}: any) {
    const {date, id, text} = note || {};

    return (
    <div 
    className=
    "max-w-sm p-6 mt-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700"
    >
    <Link href={id}>
